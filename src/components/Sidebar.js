...
const Sidebar = () => {
  ...
  return !isMenuOpen ? null : (
    ...
    <div className='h-full col-span-1'>
        <ul className="flex flex-col py-4 space-y-1 border border-b">
        <li>
          <Link to="/" className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
            ...
            <span className="ml-2 text-sm tracking-wide truncate">Music</span>
          </Link>
        </li>
        <li>
          <Link to="/" className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
            ...
            <span className="ml-2 text-sm tracking-wide truncate">Sports</span>
        ...
        <li>
          <Link to="/" className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
            ...
            <span className="ml-2 text-sm tracking-wide truncate">Gaming</span>
          </Link>
        </li>
        <li>
          <Link to="/" className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
            ...
            <span className="ml-2 text-sm tracking-wide truncate">Movies</span>
      ...
      <ul className="flex flex-col py-4 space-y-1 border border-b">
        ...
        <li>
          <Link to="/" className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
            ...
            <span className="ml-2 text-sm tracking-wide truncate">Watch Later</span>
            <span className="px-2 py-0.5 ml-auto text-xs font-medium tracking-wide text-red-500 bg-red-50 rounded-full">1.2k</span>
          </Link>
        </li>
      </ul>
